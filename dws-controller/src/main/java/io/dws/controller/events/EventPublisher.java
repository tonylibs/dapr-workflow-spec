...
public class EventPublisher {
  ...
  public void deploymentApplied(
      String workflow, String version, List<String> stepServices, String orchestratorAppId) {
    publish(
        DEPLOYMENT_APPLIED,
        deploymentData(workflow, version, stepServices, orchestratorAppId, null));
  }

  public void deploymentFailed(
      String workflow,
      String version,
      List<String> stepServices,
      String orchestratorAppId,
      String error) {
    publish(
        DEPLOYMENT_FAILED,
        deploymentData(workflow, version, stepServices, orchestratorAppId, error));
  }
  ...
  private static Map<String, Object> definitionData(
      String workflow, String version, String createdAt) {
  ...
  private static Map<String, Object> deploymentData(
      String workflow,
      String version,
      List<String> stepServices,
      String orchestratorAppId,
  ...
  private static Map<String, Object> gcData(
      String workflow, String version, String orchestratorAppId) {
    Map<String, Object> data = new LinkedHashMap<>();
    data.put("workflow", workflow);
    data.put("version", version);
    data.put("orchestratorAppId", orchestratorAppId);
