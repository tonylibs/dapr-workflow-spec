 ...
 * disposer. The client reads {@code DAPR_GRPC_PORT}/{@code DAPR_HTTP_PORT} from the sidecar-injected
 * environment; when no sidecar is present, publishing simply fails and is swallowed by
 * {@link EventPublisher} (fire-and-forget).
 */
@ApplicationScoped
