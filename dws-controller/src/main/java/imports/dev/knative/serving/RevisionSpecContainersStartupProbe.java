 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.139.0 (build 26a6b54)", date = "2026-07-23T16:02:23.164Z")
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.RevisionSpecContainersStartupProbe")
@software.amazon.jsii.Jsii.Proxy(RevisionSpecContainersStartupProbe.Jsii$Proxy.class)
public interface RevisionSpecContainersStartupProbe extends software.amazon.jsii.JsiiSerializable {

    /**
     * Exec specifies a command to execute in the container.
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersStartupProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersStartupProbeGrpc getGrpc() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersStartupProbeHttpGet getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersStartupProbeTcpSocket getTcpSocket() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link RevisionSpecContainersStartupProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link RevisionSpecContainersStartupProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<RevisionSpecContainersStartupProbe> {
        imports.dev.knative.serving.RevisionSpecContainersStartupProbeExec exec;
        java.lang.Number failureThreshold;
        imports.dev.knative.serving.RevisionSpecContainersStartupProbeGrpc grpc;
        imports.dev.knative.serving.RevisionSpecContainersStartupProbeHttpGet httpGet;
        java.lang.Number initialDelaySeconds;
        java.lang.Number periodSeconds;
        java.lang.Number successThreshold;
        imports.dev.knative.serving.RevisionSpecContainersStartupProbeTcpSocket tcpSocket;
        java.lang.Number timeoutSeconds;

        /**
         * Sets the value of {@link RevisionSpecContainersStartupProbe#getExec}
         * @param exec Exec specifies a command to execute in the container.
         * @return {@code this}
         */
        public Builder exec(imports.dev.knative.serving.RevisionSpecContainersStartupProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersStartupProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersStartupProbe#getGrpc}
         * @param grpc GRPC specifies a GRPC HealthCheckRequest.
         * @return {@code this}
         */
        public Builder grpc(imports.dev.knative.serving.RevisionSpecContainersStartupProbeGrpc grpc) {
            this.grpc = grpc;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersStartupProbe#getHttpGet}
         * @param httpGet HTTPGet specifies an HTTP GET request to perform.
         * @return {@code this}
         */
        public Builder httpGet(imports.dev.knative.serving.RevisionSpecContainersStartupProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersStartupProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersStartupProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersStartupProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersStartupProbe#getTcpSocket}
         * @param tcpSocket TCPSocket specifies a connection to a TCP port.
         * @return {@code this}
         */
        public Builder tcpSocket(imports.dev.knative.serving.RevisionSpecContainersStartupProbeTcpSocket tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersStartupProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link RevisionSpecContainersStartupProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public RevisionSpecContainersStartupProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link RevisionSpecContainersStartupProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RevisionSpecContainersStartupProbe {
        private final imports.dev.knative.serving.RevisionSpecContainersStartupProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.dev.knative.serving.RevisionSpecContainersStartupProbeGrpc grpc;
        private final imports.dev.knative.serving.RevisionSpecContainersStartupProbeHttpGet httpGet;
        ...
        private final imports.dev.knative.serving.RevisionSpecContainersStartupProbeTcpSocket tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersStartupProbeExec.class));
            ...
            this.grpc = software.amazon.jsii.Kernel.get(this, "grpc", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersStartupProbeGrpc.class));
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersStartupProbeHttpGet.class));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersStartupProbeTcpSocket.class));
        ...
        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersStartupProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersStartupProbeGrpc getGrpc() {
            return this.grpc;
        }

        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersStartupProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersStartupProbeTcpSocket getTcpSocket() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.RevisionSpecContainersStartupProbe"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            RevisionSpecContainersStartupProbe.Jsii$Proxy that = (RevisionSpecContainersStartupProbe.Jsii$Proxy) o;
