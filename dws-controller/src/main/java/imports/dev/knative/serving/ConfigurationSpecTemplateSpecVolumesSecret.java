 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.139.0 (build 26a6b54)", date = "2026-07-23T16:02:23.142Z")
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.ConfigurationSpecTemplateSpecVolumesSecret")
@software.amazon.jsii.Jsii.Proxy(ConfigurationSpecTemplateSpecVolumesSecret.Jsii$Proxy.class)
public interface ConfigurationSpecTemplateSpecVolumesSecret extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecretItems> getItems() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ConfigurationSpecTemplateSpecVolumesSecret}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ConfigurationSpecTemplateSpecVolumesSecret}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ConfigurationSpecTemplateSpecVolumesSecret> {
        java.lang.Number defaultMode;
        java.util.List<imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecretItems> items;
        java.lang.Boolean optional;
        java.lang.String secretName;

        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumesSecret#getDefaultMode}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumesSecret#getItems}
        ...
        public Builder items(java.util.List<? extends imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecretItems> items) {
            this.items = (java.util.List<imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecretItems>)items;
            return this;
        }

        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumesSecret#getOptional}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumesSecret#getSecretName}
         ...
         * @return a new instance of {@link ConfigurationSpecTemplateSpecVolumesSecret}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ConfigurationSpecTemplateSpecVolumesSecret build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ConfigurationSpecTemplateSpecVolumesSecret}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConfigurationSpecTemplateSpecVolumesSecret {
        private final java.lang.Number defaultMode;
        private final java.util.List<imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecretItems> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.items = software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecretItems.class)));
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.items = (java.util.List<imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecretItems>)builder.items;
        ...
        @Override
        public final java.util.List<imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecretItems> getItems() {
            return this.items;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.ConfigurationSpecTemplateSpecVolumesSecret"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            ConfigurationSpecTemplateSpecVolumesSecret.Jsii$Proxy that = (ConfigurationSpecTemplateSpecVolumesSecret.Jsii$Proxy) o;
