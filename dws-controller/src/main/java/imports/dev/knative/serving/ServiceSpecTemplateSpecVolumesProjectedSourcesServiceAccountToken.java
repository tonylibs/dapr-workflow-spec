...
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken")
@software.amazon.jsii.Jsii.Proxy(ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken.Jsii$Proxy.class)
public interface ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken> {
        java.lang.String path;
        java.lang.String audience;
        java.lang.Number expirationSeconds;

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken#getPath}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken#getAudience}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken#getExpirationSeconds}
         ...
         * @return a new instance of {@link ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken.Jsii$Proxy that = (ServiceSpecTemplateSpecVolumesProjectedSourcesServiceAccountToken.Jsii$Proxy) o;
