...
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.ServiceSpecTemplateSpecContainersSecurityContext")
@software.amazon.jsii.Jsii.Proxy(ServiceSpecTemplateSpecContainersSecurityContext.Jsii$Proxy.class)
public interface ServiceSpecTemplateSpecContainersSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextCapabilities getCapabilities() {
        return null;
    }
     ...
     * Note that this field cannot be set when spec.os.name is windows.
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextSeccompProfile getSeccompProfile() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ServiceSpecTemplateSpecContainersSecurityContext}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ServiceSpecTemplateSpecContainersSecurityContext}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ServiceSpecTemplateSpecContainersSecurityContext> {
        java.lang.Boolean allowPrivilegeEscalation;
        imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextCapabilities capabilities;
        ...
        imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile;

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersSecurityContext#getAllowPrivilegeEscalation}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersSecurityContext#getCapabilities}
         * @param capabilities The capabilities to add/drop when running containers.
         *                     Defaults to the default set of capabilities granted by the container runtime.
         *                     Note that this field cannot be set when spec.os.name is windows.
         * @return {@code this}
         */
        public Builder capabilities(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextCapabilities capabilities) {
            this.capabilities = capabilities;
            return this;
        }

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersSecurityContext#getPrivileged}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersSecurityContext#getReadOnlyRootFilesystem}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersSecurityContext#getRunAsGroup}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersSecurityContext#getRunAsNonRoot}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersSecurityContext#getRunAsUser}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersSecurityContext#getSeccompProfile}
         ...
         * @return {@code this}
         */
        public Builder seccompProfile(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile) {
         ...
         * @return a new instance of {@link ServiceSpecTemplateSpecContainersSecurityContext}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ServiceSpecTemplateSpecContainersSecurityContext build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ServiceSpecTemplateSpecContainersSecurityContext}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServiceSpecTemplateSpecContainersSecurityContext {
        private final java.lang.Boolean allowPrivilegeEscalation;
        private final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextCapabilities capabilities;
        ...
        private final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextCapabilities.class));
            ...
            this.seccompProfile = software.amazon.jsii.Kernel.get(this, "seccompProfile", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextSeccompProfile.class));
        }
        ...
        @Override
        public final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextCapabilities getCapabilities() {
        ...
        @Override
        public final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersSecurityContextSeccompProfile getSeccompProfile() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.ServiceSpecTemplateSpecContainersSecurityContext"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            ServiceSpecTemplateSpecContainersSecurityContext.Jsii$Proxy that = (ServiceSpecTemplateSpecContainersSecurityContext.Jsii$Proxy) o;
