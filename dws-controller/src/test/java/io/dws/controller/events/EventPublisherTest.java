...
class EventPublisherTest {
  ...
  void deploymentApplied_payload() {
    publisher.deploymentApplied(
        "order", "vabc1234", List.of("check-inventory", "charge-payment"), "order");
  ...
  void gcEvents_payload() {
    ...
    assertThat(data(drained)).containsOnlyKeys("workflow", "version", "orchestratorAppId");
  }
