 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.139.0 (build 26a6b54)", date = "2026-07-23T16:02:23.158Z")
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.RevisionSpecContainersReadinessProbe")
@software.amazon.jsii.Jsii.Proxy(RevisionSpecContainersReadinessProbe.Jsii$Proxy.class)
public interface RevisionSpecContainersReadinessProbe extends software.amazon.jsii.JsiiSerializable {

    /**
     * Exec specifies a command to execute in the container.
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersReadinessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersReadinessProbeGrpc getGrpc() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersReadinessProbeHttpGet getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersReadinessProbeTcpSocket getTcpSocket() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link RevisionSpecContainersReadinessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link RevisionSpecContainersReadinessProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<RevisionSpecContainersReadinessProbe> {
        imports.dev.knative.serving.RevisionSpecContainersReadinessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.dev.knative.serving.RevisionSpecContainersReadinessProbeGrpc grpc;
        imports.dev.knative.serving.RevisionSpecContainersReadinessProbeHttpGet httpGet;
        java.lang.Number initialDelaySeconds;
        java.lang.Number periodSeconds;
        java.lang.Number successThreshold;
        imports.dev.knative.serving.RevisionSpecContainersReadinessProbeTcpSocket tcpSocket;
        java.lang.Number timeoutSeconds;

        /**
         * Sets the value of {@link RevisionSpecContainersReadinessProbe#getExec}
         * @param exec Exec specifies a command to execute in the container.
         * @return {@code this}
         */
        public Builder exec(imports.dev.knative.serving.RevisionSpecContainersReadinessProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersReadinessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersReadinessProbe#getGrpc}
         * @param grpc GRPC specifies a GRPC HealthCheckRequest.
         * @return {@code this}
         */
        public Builder grpc(imports.dev.knative.serving.RevisionSpecContainersReadinessProbeGrpc grpc) {
            this.grpc = grpc;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersReadinessProbe#getHttpGet}
         * @param httpGet HTTPGet specifies an HTTP GET request to perform.
         * @return {@code this}
         */
        public Builder httpGet(imports.dev.knative.serving.RevisionSpecContainersReadinessProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersReadinessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersReadinessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersReadinessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersReadinessProbe#getTcpSocket}
         * @param tcpSocket TCPSocket specifies a connection to a TCP port.
         * @return {@code this}
         */
        public Builder tcpSocket(imports.dev.knative.serving.RevisionSpecContainersReadinessProbeTcpSocket tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersReadinessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link RevisionSpecContainersReadinessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public RevisionSpecContainersReadinessProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link RevisionSpecContainersReadinessProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RevisionSpecContainersReadinessProbe {
        private final imports.dev.knative.serving.RevisionSpecContainersReadinessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.dev.knative.serving.RevisionSpecContainersReadinessProbeGrpc grpc;
        private final imports.dev.knative.serving.RevisionSpecContainersReadinessProbeHttpGet httpGet;
        ...
        private final imports.dev.knative.serving.RevisionSpecContainersReadinessProbeTcpSocket tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersReadinessProbeExec.class));
            ...
            this.grpc = software.amazon.jsii.Kernel.get(this, "grpc", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersReadinessProbeGrpc.class));
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersReadinessProbeHttpGet.class));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersReadinessProbeTcpSocket.class));
        ...
        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersReadinessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersReadinessProbeGrpc getGrpc() {
            return this.grpc;
        }

        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersReadinessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersReadinessProbeTcpSocket getTcpSocket() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.RevisionSpecContainersReadinessProbe"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            RevisionSpecContainersReadinessProbe.Jsii$Proxy that = (RevisionSpecContainersReadinessProbe.Jsii$Proxy) o;
