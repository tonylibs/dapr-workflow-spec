...
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.RevisionSpecVolumesSecret")
@software.amazon.jsii.Jsii.Proxy(RevisionSpecVolumesSecret.Jsii$Proxy.class)
public interface RevisionSpecVolumesSecret extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.dev.knative.serving.RevisionSpecVolumesSecretItems> getItems() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link RevisionSpecVolumesSecret}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link RevisionSpecVolumesSecret}
     */
    public static final class Builder implements software.amazon.jsii.Builder<RevisionSpecVolumesSecret> {
        java.lang.Number defaultMode;
        java.util.List<imports.dev.knative.serving.RevisionSpecVolumesSecretItems> items;
        java.lang.Boolean optional;
        java.lang.String secretName;

        /**
         * Sets the value of {@link RevisionSpecVolumesSecret#getDefaultMode}
        ...
        /**
         * Sets the value of {@link RevisionSpecVolumesSecret#getItems}
        ...
        public Builder items(java.util.List<? extends imports.dev.knative.serving.RevisionSpecVolumesSecretItems> items) {
            this.items = (java.util.List<imports.dev.knative.serving.RevisionSpecVolumesSecretItems>)items;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecVolumesSecret#getOptional}
        ...
        /**
         * Sets the value of {@link RevisionSpecVolumesSecret#getSecretName}
         ...
         * @return a new instance of {@link RevisionSpecVolumesSecret}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public RevisionSpecVolumesSecret build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link RevisionSpecVolumesSecret}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RevisionSpecVolumesSecret {
        private final java.lang.Number defaultMode;
        private final java.util.List<imports.dev.knative.serving.RevisionSpecVolumesSecretItems> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.items = software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecVolumesSecretItems.class)));
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.items = (java.util.List<imports.dev.knative.serving.RevisionSpecVolumesSecretItems>)builder.items;
        ...
        @Override
        public final java.util.List<imports.dev.knative.serving.RevisionSpecVolumesSecretItems> getItems() {
            return this.items;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.RevisionSpecVolumesSecret"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            RevisionSpecVolumesSecret.Jsii$Proxy that = (RevisionSpecVolumesSecret.Jsii$Proxy) o;
