...
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.RevisionSpecContainersLivenessProbe")
@software.amazon.jsii.Jsii.Proxy(RevisionSpecContainersLivenessProbe.Jsii$Proxy.class)
public interface RevisionSpecContainersLivenessProbe extends software.amazon.jsii.JsiiSerializable {

    /**
     * Exec specifies a command to execute in the container.
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersLivenessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersLivenessProbeGrpc getGrpc() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersLivenessProbeHttpGet getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RevisionSpecContainersLivenessProbeTcpSocket getTcpSocket() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link RevisionSpecContainersLivenessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link RevisionSpecContainersLivenessProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<RevisionSpecContainersLivenessProbe> {
        imports.dev.knative.serving.RevisionSpecContainersLivenessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.dev.knative.serving.RevisionSpecContainersLivenessProbeGrpc grpc;
        imports.dev.knative.serving.RevisionSpecContainersLivenessProbeHttpGet httpGet;
        java.lang.Number initialDelaySeconds;
        java.lang.Number periodSeconds;
        java.lang.Number successThreshold;
        imports.dev.knative.serving.RevisionSpecContainersLivenessProbeTcpSocket tcpSocket;
        java.lang.Number timeoutSeconds;

        /**
         * Sets the value of {@link RevisionSpecContainersLivenessProbe#getExec}
         * @param exec Exec specifies a command to execute in the container.
         * @return {@code this}
         */
        public Builder exec(imports.dev.knative.serving.RevisionSpecContainersLivenessProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersLivenessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersLivenessProbe#getGrpc}
         * @param grpc GRPC specifies a GRPC HealthCheckRequest.
         * @return {@code this}
         */
        public Builder grpc(imports.dev.knative.serving.RevisionSpecContainersLivenessProbeGrpc grpc) {
            this.grpc = grpc;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersLivenessProbe#getHttpGet}
         * @param httpGet HTTPGet specifies an HTTP GET request to perform.
         * @return {@code this}
         */
        public Builder httpGet(imports.dev.knative.serving.RevisionSpecContainersLivenessProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersLivenessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersLivenessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersLivenessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link RevisionSpecContainersLivenessProbe#getTcpSocket}
         * @param tcpSocket TCPSocket specifies a connection to a TCP port.
         * @return {@code this}
         */
        public Builder tcpSocket(imports.dev.knative.serving.RevisionSpecContainersLivenessProbeTcpSocket tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link RevisionSpecContainersLivenessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link RevisionSpecContainersLivenessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public RevisionSpecContainersLivenessProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link RevisionSpecContainersLivenessProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RevisionSpecContainersLivenessProbe {
        private final imports.dev.knative.serving.RevisionSpecContainersLivenessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.dev.knative.serving.RevisionSpecContainersLivenessProbeGrpc grpc;
        private final imports.dev.knative.serving.RevisionSpecContainersLivenessProbeHttpGet httpGet;
        ...
        private final imports.dev.knative.serving.RevisionSpecContainersLivenessProbeTcpSocket tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersLivenessProbeExec.class));
            ...
            this.grpc = software.amazon.jsii.Kernel.get(this, "grpc", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersLivenessProbeGrpc.class));
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersLivenessProbeHttpGet.class));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RevisionSpecContainersLivenessProbeTcpSocket.class));
        ...
        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersLivenessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersLivenessProbeGrpc getGrpc() {
            return this.grpc;
        }

        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersLivenessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final imports.dev.knative.serving.RevisionSpecContainersLivenessProbeTcpSocket getTcpSocket() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.RevisionSpecContainersLivenessProbe"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            RevisionSpecContainersLivenessProbe.Jsii$Proxy that = (RevisionSpecContainersLivenessProbe.Jsii$Proxy) o;
