 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.139.0 (build 26a6b54)", date = "2026-07-23T16:02:23.186Z")
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.ServiceSpecTemplateSpecContainersLivenessProbe")
@software.amazon.jsii.Jsii.Proxy(ServiceSpecTemplateSpecContainersLivenessProbe.Jsii$Proxy.class)
public interface ServiceSpecTemplateSpecContainersLivenessProbe extends software.amazon.jsii.JsiiSerializable {

    /**
     * Exec specifies a command to execute in the container.
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeGrpc getGrpc() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeHttpGet getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeTcpSocket getTcpSocket() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ServiceSpecTemplateSpecContainersLivenessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ServiceSpecTemplateSpecContainersLivenessProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ServiceSpecTemplateSpecContainersLivenessProbe> {
        imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeGrpc grpc;
        imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeHttpGet httpGet;
        java.lang.Number initialDelaySeconds;
        java.lang.Number periodSeconds;
        java.lang.Number successThreshold;
        imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeTcpSocket tcpSocket;
        java.lang.Number timeoutSeconds;

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersLivenessProbe#getExec}
         * @param exec Exec specifies a command to execute in the container.
         * @return {@code this}
         */
        public Builder exec(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersLivenessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersLivenessProbe#getGrpc}
         * @param grpc GRPC specifies a GRPC HealthCheckRequest.
         * @return {@code this}
         */
        public Builder grpc(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeGrpc grpc) {
            this.grpc = grpc;
            return this;
        }

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersLivenessProbe#getHttpGet}
         * @param httpGet HTTPGet specifies an HTTP GET request to perform.
         * @return {@code this}
         */
        public Builder httpGet(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersLivenessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersLivenessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersLivenessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersLivenessProbe#getTcpSocket}
         * @param tcpSocket TCPSocket specifies a connection to a TCP port.
         * @return {@code this}
         */
        public Builder tcpSocket(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeTcpSocket tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersLivenessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link ServiceSpecTemplateSpecContainersLivenessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ServiceSpecTemplateSpecContainersLivenessProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ServiceSpecTemplateSpecContainersLivenessProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServiceSpecTemplateSpecContainersLivenessProbe {
        private final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeGrpc grpc;
        private final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeHttpGet httpGet;
        ...
        private final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeTcpSocket tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeExec.class));
            ...
            this.grpc = software.amazon.jsii.Kernel.get(this, "grpc", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeGrpc.class));
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeHttpGet.class));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeTcpSocket.class));
        ...
        @Override
        public final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeGrpc getGrpc() {
            return this.grpc;
        }

        @Override
        public final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersLivenessProbeTcpSocket getTcpSocket() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.ServiceSpecTemplateSpecContainersLivenessProbe"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            ServiceSpecTemplateSpecContainersLivenessProbe.Jsii$Proxy that = (ServiceSpecTemplateSpecContainersLivenessProbe.Jsii$Proxy) o;
