...
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.ServiceSpecTemplateSpecContainersStartupProbe")
@software.amazon.jsii.Jsii.Proxy(ServiceSpecTemplateSpecContainersStartupProbe.Jsii$Proxy.class)
public interface ServiceSpecTemplateSpecContainersStartupProbe extends software.amazon.jsii.JsiiSerializable {

    /**
     * Exec specifies a command to execute in the container.
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeGrpc getGrpc() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeHttpGet getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeTcpSocket getTcpSocket() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ServiceSpecTemplateSpecContainersStartupProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ServiceSpecTemplateSpecContainersStartupProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ServiceSpecTemplateSpecContainersStartupProbe> {
        imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeExec exec;
        java.lang.Number failureThreshold;
        imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeGrpc grpc;
        imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeHttpGet httpGet;
        java.lang.Number initialDelaySeconds;
        java.lang.Number periodSeconds;
        java.lang.Number successThreshold;
        imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeTcpSocket tcpSocket;
        java.lang.Number timeoutSeconds;

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersStartupProbe#getExec}
         * @param exec Exec specifies a command to execute in the container.
         * @return {@code this}
         */
        public Builder exec(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersStartupProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersStartupProbe#getGrpc}
         * @param grpc GRPC specifies a GRPC HealthCheckRequest.
         * @return {@code this}
         */
        public Builder grpc(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeGrpc grpc) {
            this.grpc = grpc;
            return this;
        }

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersStartupProbe#getHttpGet}
         * @param httpGet HTTPGet specifies an HTTP GET request to perform.
         * @return {@code this}
         */
        public Builder httpGet(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersStartupProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersStartupProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersStartupProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersStartupProbe#getTcpSocket}
         * @param tcpSocket TCPSocket specifies a connection to a TCP port.
         * @return {@code this}
         */
        public Builder tcpSocket(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeTcpSocket tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersStartupProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link ServiceSpecTemplateSpecContainersStartupProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ServiceSpecTemplateSpecContainersStartupProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ServiceSpecTemplateSpecContainersStartupProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServiceSpecTemplateSpecContainersStartupProbe {
        private final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeGrpc grpc;
        private final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeHttpGet httpGet;
        ...
        private final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeTcpSocket tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeExec.class));
            ...
            this.grpc = software.amazon.jsii.Kernel.get(this, "grpc", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeGrpc.class));
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeHttpGet.class));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeTcpSocket.class));
        ...
        @Override
        public final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeGrpc getGrpc() {
            return this.grpc;
        }

        @Override
        public final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final imports.dev.knative.serving.ServiceSpecTemplateSpecContainersStartupProbeTcpSocket getTcpSocket() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.ServiceSpecTemplateSpecContainersStartupProbe"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            ServiceSpecTemplateSpecContainersStartupProbe.Jsii$Proxy that = (ServiceSpecTemplateSpecContainersStartupProbe.Jsii$Proxy) o;
