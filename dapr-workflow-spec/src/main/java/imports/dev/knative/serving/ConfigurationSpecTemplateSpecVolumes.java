 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.139.0 (build 26a6b54)", date = "2026-07-23T16:02:23.135Z")
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.ConfigurationSpecTemplateSpecVolumes")
@software.amazon.jsii.Jsii.Proxy(ConfigurationSpecTemplateSpecVolumes.Jsii$Proxy.class)
public interface ConfigurationSpecTemplateSpecVolumes extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesConfigMap getConfigMap() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesProjected getProjected() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecret getSecret() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ConfigurationSpecTemplateSpecVolumes}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ConfigurationSpecTemplateSpecVolumes}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ConfigurationSpecTemplateSpecVolumes> {
        java.lang.String name;
        imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesConfigMap configMap;
        java.lang.Object csi;
        java.lang.Object emptyDir;
        java.lang.Object hostPath;
        java.lang.Object image;
        java.lang.Object persistentVolumeClaim;
        imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesProjected projected;
        imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecret secret;

        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumes#getName}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumes#getConfigMap}
         * @param configMap configMap represents a configMap that should populate this volume.
         * @return {@code this}
         */
        public Builder configMap(imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesConfigMap configMap) {
            this.configMap = configMap;
            return this;
        }

        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumes#getCsi}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumes#getEmptyDir}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumes#getHostPath}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumes#getImage}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumes#getPersistentVolumeClaim}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumes#getProjected}
         * @param projected projected items for all in one resources secrets, configmaps, and downward API.
         * @return {@code this}
         */
        public Builder projected(imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesProjected projected) {
            this.projected = projected;
            return this;
        }

        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecVolumes#getSecret}
         * @param secret secret represents a secret that should populate this volume.
         *               More info: https://kubernetes.io/docs/concepts/storage/volumes#secret
         * @return {@code this}
         */
        public Builder secret(imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecret secret) {
            this.secret = secret;
            return this;
        }
         ...
         * @return a new instance of {@link ConfigurationSpecTemplateSpecVolumes}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ConfigurationSpecTemplateSpecVolumes build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ConfigurationSpecTemplateSpecVolumes}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConfigurationSpecTemplateSpecVolumes {
        private final java.lang.String name;
        private final imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesConfigMap configMap;
        ...
        private final imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesProjected projected;
        private final imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecret secret;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.configMap = software.amazon.jsii.Kernel.get(this, "configMap", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesConfigMap.class));
            ...
            this.projected = software.amazon.jsii.Kernel.get(this, "projected", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesProjected.class));
            this.secret = software.amazon.jsii.Kernel.get(this, "secret", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecret.class));
        }
        ...
        @Override
        public final imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesConfigMap getConfigMap() {
        ...
        @Override
        public final imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesProjected getProjected() {
            return this.projected;
        }

        @Override
        public final imports.dev.knative.serving.ConfigurationSpecTemplateSpecVolumesSecret getSecret() {
            return this.secret;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.ConfigurationSpecTemplateSpecVolumes"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            ConfigurationSpecTemplateSpecVolumes.Jsii$Proxy that = (ConfigurationSpecTemplateSpecVolumes.Jsii$Proxy) o;
