...
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.RouteProps")
...
public interface RouteProps extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.RouteSpec getSpec() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<RouteProps> {
        ...
        imports.dev.knative.serving.RouteSpec spec;

        /**
         * Sets the value of {@link RouteProps#getMetadata}
        ...
        /**
         * Sets the value of {@link RouteProps#getSpec}
         * @param spec Spec holds the desired state of the Route (from the client).
         * @return {@code this}
         */
        public Builder spec(imports.dev.knative.serving.RouteSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RouteProps {
        ...
        private final imports.dev.knative.serving.RouteSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.RouteSpec.class));
        }
        ...
        @Override
        public final imports.dev.knative.serving.RouteSpec getSpec() {
            return this.spec;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.RouteProps"));
