 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.139.0 (build 26a6b54)", date = "2026-07-23T16:02:23.122Z")
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.ConfigurationSpecTemplateSpecContainersSecurityContext")
@software.amazon.jsii.Jsii.Proxy(ConfigurationSpecTemplateSpecContainersSecurityContext.Jsii$Proxy.class)
public interface ConfigurationSpecTemplateSpecContainersSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextCapabilities getCapabilities() {
        return null;
    }
     ...
     * Note that this field cannot be set when spec.os.name is windows.
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextSeccompProfile getSeccompProfile() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ConfigurationSpecTemplateSpecContainersSecurityContext}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ConfigurationSpecTemplateSpecContainersSecurityContext}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ConfigurationSpecTemplateSpecContainersSecurityContext> {
        java.lang.Boolean allowPrivilegeEscalation;
        imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextCapabilities capabilities;
        ...
        imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile;

        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecContainersSecurityContext#getAllowPrivilegeEscalation}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecContainersSecurityContext#getCapabilities}
         * @param capabilities The capabilities to add/drop when running containers.
         *                     Defaults to the default set of capabilities granted by the container runtime.
         *                     Note that this field cannot be set when spec.os.name is windows.
         * @return {@code this}
         */
        public Builder capabilities(imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextCapabilities capabilities) {
            this.capabilities = capabilities;
            return this;
        }

        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecContainersSecurityContext#getPrivileged}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecContainersSecurityContext#getReadOnlyRootFilesystem}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecContainersSecurityContext#getRunAsGroup}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecContainersSecurityContext#getRunAsNonRoot}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecContainersSecurityContext#getRunAsUser}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecTemplateSpecContainersSecurityContext#getSeccompProfile}
         ...
         * @return {@code this}
         */
        public Builder seccompProfile(imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile) {
         ...
         * @return a new instance of {@link ConfigurationSpecTemplateSpecContainersSecurityContext}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ConfigurationSpecTemplateSpecContainersSecurityContext build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ConfigurationSpecTemplateSpecContainersSecurityContext}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConfigurationSpecTemplateSpecContainersSecurityContext {
        private final java.lang.Boolean allowPrivilegeEscalation;
        private final imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextCapabilities capabilities;
        ...
        private final imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextCapabilities.class));
            ...
            this.seccompProfile = software.amazon.jsii.Kernel.get(this, "seccompProfile", software.amazon.jsii.NativeType.forClass(imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextSeccompProfile.class));
        }
        ...
        @Override
        public final imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextCapabilities getCapabilities() {
        ...
        @Override
        public final imports.dev.knative.serving.ConfigurationSpecTemplateSpecContainersSecurityContextSeccompProfile getSeccompProfile() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.ConfigurationSpecTemplateSpecContainersSecurityContext"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            ConfigurationSpecTemplateSpecContainersSecurityContext.Jsii$Proxy that = (ConfigurationSpecTemplateSpecContainersSecurityContext.Jsii$Proxy) o;
