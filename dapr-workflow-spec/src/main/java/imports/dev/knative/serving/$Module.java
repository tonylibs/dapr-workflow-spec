...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("imports/dev/knative/serving/$Module.txt");
    ...
    public $Module() {
        super("devknativeserving", "0.0.0", $Module.class, "devknativeserving@0.0.0.jsii.tgz");
    }
