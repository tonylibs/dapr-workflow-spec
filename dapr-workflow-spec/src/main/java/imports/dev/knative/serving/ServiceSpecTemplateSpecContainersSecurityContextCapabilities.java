...
@software.amazon.jsii.Jsii(module = imports.dev.knative.serving.$Module.class, fqn = "devknativeserving.ServiceSpecTemplateSpecContainersSecurityContextCapabilities")
@software.amazon.jsii.Jsii.Proxy(ServiceSpecTemplateSpecContainersSecurityContextCapabilities.Jsii$Proxy.class)
public interface ServiceSpecTemplateSpecContainersSecurityContextCapabilities extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ServiceSpecTemplateSpecContainersSecurityContextCapabilities}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ServiceSpecTemplateSpecContainersSecurityContextCapabilities}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ServiceSpecTemplateSpecContainersSecurityContextCapabilities> {
        java.util.List<java.lang.String> add;
        java.util.List<java.lang.String> drop;

        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersSecurityContextCapabilities#getAdd}
        ...
        /**
         * Sets the value of {@link ServiceSpecTemplateSpecContainersSecurityContextCapabilities#getDrop}
         ...
         * @return a new instance of {@link ServiceSpecTemplateSpecContainersSecurityContextCapabilities}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ServiceSpecTemplateSpecContainersSecurityContextCapabilities build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ServiceSpecTemplateSpecContainersSecurityContextCapabilities}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServiceSpecTemplateSpecContainersSecurityContextCapabilities {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeserving.ServiceSpecTemplateSpecContainersSecurityContextCapabilities"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            ServiceSpecTemplateSpecContainersSecurityContextCapabilities.Jsii$Proxy that = (ServiceSpecTemplateSpecContainersSecurityContextCapabilities.Jsii$Proxy) o;
