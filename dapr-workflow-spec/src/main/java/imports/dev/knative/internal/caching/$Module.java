...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("imports/dev/knative/internal/caching/$Module.txt");
    ...
    public $Module() {
        super("devknativeinternalcaching", "0.0.0", $Module.class, "devknativeinternalcaching@0.0.0.jsii.tgz");
    }
