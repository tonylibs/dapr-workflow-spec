 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.139.0 (build 26a6b54)", date = "2026-07-23T16:02:14.113Z")
@software.amazon.jsii.Jsii(module = imports.dev.knative.internal.networking.$Module.class, fqn = "devknativeinternalnetworking.CertificateProps")
...
public interface CertificateProps extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.internal.networking.CertificateSpec getSpec() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CertificateProps> {
        ...
        imports.dev.knative.internal.networking.CertificateSpec spec;
         ...
         * @param spec Spec is the desired state of the Certificate.
         *             More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
         * @return {@code this}
         */
        public Builder spec(imports.dev.knative.internal.networking.CertificateSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CertificateProps {
        ...
        private final imports.dev.knative.internal.networking.CertificateSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.dev.knative.internal.networking.CertificateSpec.class));
        }
        ...
        @Override
        public final imports.dev.knative.internal.networking.CertificateSpec getSpec() {
            return this.spec;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeinternalnetworking.CertificateProps"));
