...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("imports/dev/knative/internal/autoscaling/$Module.txt");
    ...
    public $Module() {
        super("devknativeinternalautoscaling", "0.0.0", $Module.class, "devknativeinternalautoscaling@0.0.0.jsii.tgz");
    }
