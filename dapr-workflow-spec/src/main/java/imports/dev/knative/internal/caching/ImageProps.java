 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.139.0 (build 26a6b54)", date = "2026-07-23T16:02:07.186Z")
@software.amazon.jsii.Jsii(module = imports.dev.knative.internal.caching.$Module.class, fqn = "devknativeinternalcaching.ImageProps")
...
public interface ImageProps extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.dev.knative.internal.caching.ImageSpec getSpec() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ImageProps> {
        ...
        imports.dev.knative.internal.caching.ImageSpec spec;

        /**
         * Sets the value of {@link ImageProps#getMetadata}
        ...
        /**
         * Sets the value of {@link ImageProps#getSpec}
         * @param spec Spec holds the desired state of the Image (from the client).
         * @return {@code this}
         */
        public Builder spec(imports.dev.knative.internal.caching.ImageSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ImageProps {
        ...
        private final imports.dev.knative.internal.caching.ImageSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.dev.knative.internal.caching.ImageSpec.class));
        }
        ...
        @Override
        public final imports.dev.knative.internal.caching.ImageSpec getSpec() {
            return this.spec;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("devknativeinternalcaching.ImageProps"));
