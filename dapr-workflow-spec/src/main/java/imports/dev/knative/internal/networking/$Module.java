...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("imports/dev/knative/internal/networking/$Module.txt");
    ...
    public $Module() {
        super("devknativeinternalnetworking", "0.0.0", $Module.class, "devknativeinternalnetworking@0.0.0.jsii.tgz");
    }
