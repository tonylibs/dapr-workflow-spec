 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.139.0 (build 26a6b54)", date = "2026-07-23T16:14:16.441Z")
@software.amazon.jsii.Jsii(module = imports.io.dapr.$Module.class, fqn = "iodapr.ConfigurationSpecMetric")
@software.amazon.jsii.Jsii.Proxy(ConfigurationSpecMetric.Jsii$Proxy.class)
public interface ConfigurationSpecMetric extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.io.dapr.ConfigurationSpecMetricHttp getHttp() {
        return null;
    }
    ...
    /**
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.io.dapr.ConfigurationSpecMetricRules> getRules() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ConfigurationSpecMetric}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ConfigurationSpecMetric}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ConfigurationSpecMetric> {
        java.lang.Boolean enabled;
        imports.io.dapr.ConfigurationSpecMetricHttp http;
        java.util.List<java.lang.Number> latencyDistributionBuckets;
        java.lang.Boolean recordErrorCodes;
        java.util.List<imports.io.dapr.ConfigurationSpecMetricRules> rules;

        /**
         * Sets the value of {@link ConfigurationSpecMetric#getEnabled}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecMetric#getHttp}
         * @param http MetricHTTP defines configuration for metrics for the HTTP server.
         * @return {@code this}
         */
        public Builder http(imports.io.dapr.ConfigurationSpecMetricHttp http) {
            this.http = http;
            return this;
        }

        /**
         * Sets the value of {@link ConfigurationSpecMetric#getLatencyDistributionBuckets}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecMetric#getRecordErrorCodes}
        ...
        /**
         * Sets the value of {@link ConfigurationSpecMetric#getRules}
         * @param rules the value to be set.
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder rules(java.util.List<? extends imports.io.dapr.ConfigurationSpecMetricRules> rules) {
            this.rules = (java.util.List<imports.io.dapr.ConfigurationSpecMetricRules>)rules;
            return this;
        }

        /**
         * Builds the configured instance.
         * @return a new instance of {@link ConfigurationSpecMetric}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ConfigurationSpecMetric build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ConfigurationSpecMetric}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConfigurationSpecMetric {
        private final java.lang.Boolean enabled;
        private final imports.io.dapr.ConfigurationSpecMetricHttp http;
        private final java.util.List<java.lang.Number> latencyDistributionBuckets;
        private final java.lang.Boolean recordErrorCodes;
        private final java.util.List<imports.io.dapr.ConfigurationSpecMetricRules> rules;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.http = software.amazon.jsii.Kernel.get(this, "http", software.amazon.jsii.NativeType.forClass(imports.io.dapr.ConfigurationSpecMetricHttp.class));
            ...
            this.rules = software.amazon.jsii.Kernel.get(this, "rules", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.io.dapr.ConfigurationSpecMetricRules.class)));
        }
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.rules = (java.util.List<imports.io.dapr.ConfigurationSpecMetricRules>)builder.rules;
        }
        ...
        @Override
        public final imports.io.dapr.ConfigurationSpecMetricHttp getHttp() {
            return this.http;
        }
        ...
        @Override
        public final java.util.List<imports.io.dapr.ConfigurationSpecMetricRules> getRules() {
            return this.rules;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("iodapr.ConfigurationSpecMetric"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            ConfigurationSpecMetric.Jsii$Proxy that = (ConfigurationSpecMetric.Jsii$Proxy) o;
