...
@software.amazon.jsii.Jsii(module = imports.io.dapr.$Module.class, fqn = "iodapr.McpServerSpecEndpointStreamableHttp")
@software.amazon.jsii.Jsii.Proxy(McpServerSpecEndpointStreamableHttp.Jsii$Proxy.class)
public interface McpServerSpecEndpointStreamableHttp extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.io.dapr.McpServerSpecEndpointStreamableHttpAuth getAuth() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.io.dapr.McpServerSpecEndpointStreamableHttpHeaders> getHeaders() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link McpServerSpecEndpointStreamableHttp}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link McpServerSpecEndpointStreamableHttp}
     */
    public static final class Builder implements software.amazon.jsii.Builder<McpServerSpecEndpointStreamableHttp> {
        java.lang.String url;
        imports.io.dapr.McpServerSpecEndpointStreamableHttpAuth auth;
        java.util.List<imports.io.dapr.McpServerSpecEndpointStreamableHttpHeaders> headers;
        java.lang.String protocolVersion;
        java.lang.String timeout;

        /**
         * Sets the value of {@link McpServerSpecEndpointStreamableHttp#getUrl}
        ...
        /**
         * Sets the value of {@link McpServerSpecEndpointStreamableHttp#getAuth}
         * @param auth Auth configures authentication for the MCP server connection.
         * @return {@code this}
         */
        public Builder auth(imports.io.dapr.McpServerSpecEndpointStreamableHttpAuth auth) {
            this.auth = auth;
            return this;
        }

        /**
         * Sets the value of {@link McpServerSpecEndpointStreamableHttp#getHeaders}
        ...
        public Builder headers(java.util.List<? extends imports.io.dapr.McpServerSpecEndpointStreamableHttpHeaders> headers) {
            this.headers = (java.util.List<imports.io.dapr.McpServerSpecEndpointStreamableHttpHeaders>)headers;
            return this;
        }

        /**
         * Sets the value of {@link McpServerSpecEndpointStreamableHttp#getProtocolVersion}
        ...
        /**
         * Sets the value of {@link McpServerSpecEndpointStreamableHttp#getTimeout}
         ...
         * @return a new instance of {@link McpServerSpecEndpointStreamableHttp}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public McpServerSpecEndpointStreamableHttp build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link McpServerSpecEndpointStreamableHttp}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements McpServerSpecEndpointStreamableHttp {
        private final java.lang.String url;
        private final imports.io.dapr.McpServerSpecEndpointStreamableHttpAuth auth;
        private final java.util.List<imports.io.dapr.McpServerSpecEndpointStreamableHttpHeaders> headers;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.auth = software.amazon.jsii.Kernel.get(this, "auth", software.amazon.jsii.NativeType.forClass(imports.io.dapr.McpServerSpecEndpointStreamableHttpAuth.class));
            this.headers = software.amazon.jsii.Kernel.get(this, "headers", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.io.dapr.McpServerSpecEndpointStreamableHttpHeaders.class)));
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.headers = (java.util.List<imports.io.dapr.McpServerSpecEndpointStreamableHttpHeaders>)builder.headers;
        ...
        @Override
        public final imports.io.dapr.McpServerSpecEndpointStreamableHttpAuth getAuth() {
            return this.auth;
        }

        @Override
        public final java.util.List<imports.io.dapr.McpServerSpecEndpointStreamableHttpHeaders> getHeaders() {
            return this.headers;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("iodapr.McpServerSpecEndpointStreamableHttp"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            McpServerSpecEndpointStreamableHttp.Jsii$Proxy that = (McpServerSpecEndpointStreamableHttp.Jsii$Proxy) o;
