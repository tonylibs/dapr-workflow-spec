...
@software.amazon.jsii.Jsii(module = imports.io.dapr.$Module.class, fqn = "iodapr.McpServerSpecMiddlewareAfterCallToolWorkflow")
@software.amazon.jsii.Jsii.Proxy(McpServerSpecMiddlewareAfterCallToolWorkflow.Jsii$Proxy.class)
public interface McpServerSpecMiddlewareAfterCallToolWorkflow extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link McpServerSpecMiddlewareAfterCallToolWorkflow}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link McpServerSpecMiddlewareAfterCallToolWorkflow}
     */
    public static final class Builder implements software.amazon.jsii.Builder<McpServerSpecMiddlewareAfterCallToolWorkflow> {
        java.lang.String workflowName;
        java.lang.String appId;

        /**
         * Sets the value of {@link McpServerSpecMiddlewareAfterCallToolWorkflow#getWorkflowName}
        ...
        /**
         * Sets the value of {@link McpServerSpecMiddlewareAfterCallToolWorkflow#getAppId}
         ...
         * @return a new instance of {@link McpServerSpecMiddlewareAfterCallToolWorkflow}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public McpServerSpecMiddlewareAfterCallToolWorkflow build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link McpServerSpecMiddlewareAfterCallToolWorkflow}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements McpServerSpecMiddlewareAfterCallToolWorkflow {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("iodapr.McpServerSpecMiddlewareAfterCallToolWorkflow"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            McpServerSpecMiddlewareAfterCallToolWorkflow.Jsii$Proxy that = (McpServerSpecMiddlewareAfterCallToolWorkflow.Jsii$Proxy) o;
