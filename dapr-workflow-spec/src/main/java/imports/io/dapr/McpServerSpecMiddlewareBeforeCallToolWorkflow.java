...
@software.amazon.jsii.Jsii(module = imports.io.dapr.$Module.class, fqn = "iodapr.McpServerSpecMiddlewareBeforeCallToolWorkflow")
@software.amazon.jsii.Jsii.Proxy(McpServerSpecMiddlewareBeforeCallToolWorkflow.Jsii$Proxy.class)
public interface McpServerSpecMiddlewareBeforeCallToolWorkflow extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link McpServerSpecMiddlewareBeforeCallToolWorkflow}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link McpServerSpecMiddlewareBeforeCallToolWorkflow}
     */
    public static final class Builder implements software.amazon.jsii.Builder<McpServerSpecMiddlewareBeforeCallToolWorkflow> {
        java.lang.String workflowName;
        java.lang.String appId;

        /**
         * Sets the value of {@link McpServerSpecMiddlewareBeforeCallToolWorkflow#getWorkflowName}
        ...
        /**
         * Sets the value of {@link McpServerSpecMiddlewareBeforeCallToolWorkflow#getAppId}
         ...
         * @return a new instance of {@link McpServerSpecMiddlewareBeforeCallToolWorkflow}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public McpServerSpecMiddlewareBeforeCallToolWorkflow build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link McpServerSpecMiddlewareBeforeCallToolWorkflow}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements McpServerSpecMiddlewareBeforeCallToolWorkflow {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("iodapr.McpServerSpecMiddlewareBeforeCallToolWorkflow"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            McpServerSpecMiddlewareBeforeCallToolWorkflow.Jsii$Proxy that = (McpServerSpecMiddlewareBeforeCallToolWorkflow.Jsii$Proxy) o;
