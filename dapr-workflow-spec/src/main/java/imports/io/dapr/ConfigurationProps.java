...
@software.amazon.jsii.Jsii(module = imports.io.dapr.$Module.class, fqn = "iodapr.ConfigurationProps")
...
public interface ConfigurationProps extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.io.dapr.ConfigurationSpec getSpec() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ConfigurationProps> {
        ...
        imports.io.dapr.ConfigurationSpec spec;
         ...
         * @param spec ConfigurationSpec is the spec for a configuration.
         * @return {@code this}
         */
        public Builder spec(imports.io.dapr.ConfigurationSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConfigurationProps {
        ...
        private final imports.io.dapr.ConfigurationSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.io.dapr.ConfigurationSpec.class));
        }
        ...
        @Override
        public final imports.io.dapr.ConfigurationSpec getSpec() {
            return this.spec;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("iodapr.ConfigurationProps"));
