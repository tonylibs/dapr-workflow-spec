...
@software.amazon.jsii.Jsii(module = imports.io.dapr.$Module.class, fqn = "iodapr.McpServerSpecMiddlewareBeforeListToolsWorkflow")
@software.amazon.jsii.Jsii.Proxy(McpServerSpecMiddlewareBeforeListToolsWorkflow.Jsii$Proxy.class)
public interface McpServerSpecMiddlewareBeforeListToolsWorkflow extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link McpServerSpecMiddlewareBeforeListToolsWorkflow}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link McpServerSpecMiddlewareBeforeListToolsWorkflow}
     */
    public static final class Builder implements software.amazon.jsii.Builder<McpServerSpecMiddlewareBeforeListToolsWorkflow> {
        java.lang.String workflowName;
        java.lang.String appId;

        /**
         * Sets the value of {@link McpServerSpecMiddlewareBeforeListToolsWorkflow#getWorkflowName}
        ...
        /**
         * Sets the value of {@link McpServerSpecMiddlewareBeforeListToolsWorkflow#getAppId}
         ...
         * @return a new instance of {@link McpServerSpecMiddlewareBeforeListToolsWorkflow}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public McpServerSpecMiddlewareBeforeListToolsWorkflow build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link McpServerSpecMiddlewareBeforeListToolsWorkflow}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements McpServerSpecMiddlewareBeforeListToolsWorkflow {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("iodapr.McpServerSpecMiddlewareBeforeListToolsWorkflow"));
        ...
        public final boolean equals(final java.lang.Object o) {
            ...
            McpServerSpecMiddlewareBeforeListToolsWorkflow.Jsii$Proxy that = (McpServerSpecMiddlewareBeforeListToolsWorkflow.Jsii$Proxy) o;
